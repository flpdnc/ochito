        ...
        match newrunstate {
            ...
            _ => {
...

                {
                    ...
                    data.sort_by(
                        |&a, &b| b.1.render_order.cmp(&a.1.render_order) 
                        );
...
impl State {
    ...
    fn goto_next_level(&mut self) {
        ...
        // Build a new map and place for the player
        let worldmap;
        let current_depth;
        {
...
fn main() -> rltk::BError {
    ...
    gs.ecs.insert(
        gamelog::GameLog{
            entries : vec!["Welcome to Ochito Roguelike".to_string()]
        });
